...
namespace Property.Admin
{
    public partial class AppointmentList : System.Web.UI.Page
    {
        ...
        protected void FillGridData()
       {
        ...
        protected DataTable GetAdminAppointments()
        {
            ...
            try
            {
                ...
                string str = "select * from [tbl_ScheduleAppointmentAdmin]";
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                dt.TableName = "tbl_ScheduleAppointmentAdmin";
            }
            catch (Exception ex)
            { }
            finally
        ...
        protected void grdUsers_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandArgument == "delete")
            {
                foreach (GridViewRow gvrow in grdUsers.Rows)
                {
                    ...
                    cmd.CommandText = "delete from  tbl_ScheduleAppointmentAdmin where id ='" + ID + "'";
                }
            }
        }
        ...
        {
            Response.Redirect("ScheduleAppointmentAdmin.aspx");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Delete from tbl_ScheduleAppointmentAdmin where ID in(" + SelectedIds + ")", conn);
