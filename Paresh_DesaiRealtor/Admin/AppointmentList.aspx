<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="AppointmentList.aspx.cs" Inherits="Property.Admin.AppointmentList" %>
        ...
        <div class="content">
            ...
            <div class="module">
                ...
                <div class="module-body">
                     <p>
                        <asp:Button ID="btnaddusers"  runat="server" class="btn btn-primary" Text="Add Appointment" OnClick="btnaddusers_Click" />                                     
                    ...
                    <asp:GridView ID="grdUsers" class="table table-striped table-bordered table-condensed" PageSize="10" AutoGenerateColumns="False" runat="server"
                        ...
                        <%--    <asp:BoundField DataField="ID" HeaderText="#" SortExpression="ID"></asp:BoundField>--%>
                            ...
                            <asp:BoundField DataField="AppointmentTime" HeaderText="Appointment Time" SortExpression="AppointmentTime"></asp:BoundField>
                            <asp:BoundField DataField="Notes" HeaderText="Notes" SortExpression="Notes"></asp:BoundField>
                   

                            <asp:TemplateField HeaderText="Edit">
                                <ItemTemplate>
                                    <a id="id" href="ScheduleAppointmentAdmin.aspx?edit=<%#Eval("ID") %>">
